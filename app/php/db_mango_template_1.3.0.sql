...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2019 at 01:58 PM
...
INSERT INTO `client2` (`ProjectID`, `ClientID`, `AccountID`, `TeamID`, `FirstName`, `LastName`, `Country`, `ContactNumber`, `Email`, `Facebook`, `BuyingStage`, `BuyingPurpose`, `Source`, `InterestLevel`, `Notes`, `ProjectName`, `Unit`, `PreferredSize`, `EstimatedAmount`, `FinalAmount`, `DateAwareness`, `DateConsideration`, `DateDecision`, `AverageDaysDecision`) VALUES
(1, 1, 55, 1, 'Airi', 'Satou', 'Japan', '09123456789', 'satou@gmail.jp.com', 'facebook.com/airi143', 'Decision - Won', 'Investment', 'Social Media', 'High', 'Sample note', 'DBR-SR', 'unit xhr-056', 'any size', 23000, 20000, '2019-04-01', '2019-04-03', '2019-04-05', 4),
(2, 2, 55, 1, 'Cara', 'Stevens', 'American Samoa', '09123456789', 'cstevens@special.com', 'facebook.com/cstevens', 'Awareness', 'Business', 'Walk In', 'Neutral', 'Meetup next Tuesday', 'TCRS', 'unit tcrs-143', 'Queen Size', 36500, 0, '2019-04-12', '0000-00-00', '0000-00-00', 0),
(3, 2, 55, 1, 'Cara', 'Stevens', 'American Samoa', '09123456789', 'cstevens@special.com', 'facebook.com/cstevens', 'Decision - Won', 'Investment', 'Walk In', 'High', '', 'DBR-SR', 'unit xhr-056', 'King Size', 0, 25000, '2019-04-11', '0000-00-00', '2019-04-11', 0);
